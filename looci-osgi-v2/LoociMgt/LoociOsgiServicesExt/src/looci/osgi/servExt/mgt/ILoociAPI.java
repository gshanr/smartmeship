...
public interface ILoociAPI extends IIntrospectionAPI,IRunTimeControlAPI {

	public void sendEvent(short eventType, byte[] content, String address, byte dstComp) throws UnknownHostException;
	
	public Event sendEventGetReply(short eventType, byte[] content, String address, byte dstComp, short replyType)  throws UnknownHostException;
