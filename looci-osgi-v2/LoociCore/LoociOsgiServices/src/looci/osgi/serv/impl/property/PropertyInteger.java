...
public class PropertyInteger extends Property {
	...
	public PropertyInteger(short propertyId, String name, int newVal) {
		super(propertyId,LoociConstants.DATATYPE_INT, name);
		val = newVal;
	}
	...
	public byte[] toByteArray() {
		return Utils.convertIntToByteArray(val);
	}

	@Override
	public void fromByteArray(byte[] input) throws LoociManagementException {
		val = Utils.convertByteArrayToInt(input);
	}
