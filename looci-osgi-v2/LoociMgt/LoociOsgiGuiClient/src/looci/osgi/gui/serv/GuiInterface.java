...
public interface GuiInterface extends Serializable{
	...
	public void addSelectionListener(String listenerId,  SelectionListener listener);
	
	public void removeSelectionListener(String listenerId, SelectionListener listener);
