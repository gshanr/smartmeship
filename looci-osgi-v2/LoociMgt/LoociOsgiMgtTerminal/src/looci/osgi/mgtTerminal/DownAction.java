...
public class DownAction extends AbstractAction {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1366015066286773726L;
	private JTextArea area;
    private History history;
    
    public DownAction(JTextArea area, History history) {
        this.area = area;
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        area.replaceRange(history.getNext(), index, text.length());
    }    
}
