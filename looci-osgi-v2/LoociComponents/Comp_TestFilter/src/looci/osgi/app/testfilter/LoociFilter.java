 ...
 */
public class LoociFilter extends LoociCodebase {
	
	public LoociFilter() {
		super("testFilter", // no provided interfaces
				new short[] { 
				(short) EventTypes.TEMP_READING},
				new short[] {(short) EventTypes.TEMP_READING}); 
	}

	@Override
	public ILoociComponent createLoociComponent() {
		return new LoociFilterComponent();
	}	
}
