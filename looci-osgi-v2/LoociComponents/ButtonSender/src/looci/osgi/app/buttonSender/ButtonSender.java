 ...
 */
public class ButtonSender extends LoociCodebase {
	
	public ButtonSender() {
		super("button and temp sensor", // no provided interfaces
				new short[] { 
				EventTypes.TEMP_READING,
				EventTypes.BUTTON_READING},
				new short[] {}); 
	}

	@Override
	public ILoociComponent createLoociComponent() {
		return new ButtonSenderComponent();
	}	
}
