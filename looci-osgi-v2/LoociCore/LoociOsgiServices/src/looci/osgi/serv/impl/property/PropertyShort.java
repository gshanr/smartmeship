...
public class PropertyShort extends Property {

	private short val;
	
	public PropertyShort(short propertyId, String name, short newVal) {
		super(propertyId,LoociConstants.DATATYPE_SHORT, name);
		val = newVal;
	}
	...
	public byte[] toByteArray() {
		return Utils.convertShortToByteArray(val);
	}

	@Override
	public void fromByteArray(byte[] input) throws LoociManagementException {
		val = Utils.convertByteArrayToShort(input);
	}
}
